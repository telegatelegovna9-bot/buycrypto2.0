            ...
            for symbol in symbols_to_remove:
                ...
                if position:
                    ...
                    try:
                        ...
                        # Stats update is now handled exclusively by PositionMonitor
                        # to avoid double-counting trades
                        logger.debug(f"[STATS] Strategy {strategy_name} detected for {symbol}, stats will be updated by PositionMonitor")
